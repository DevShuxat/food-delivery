...
//use App\Http\Resources\Core\EmptyResourceCollection;
...
trait ApiResponseTrait
{
    ...
    {
        return $this->respondWithResource(new CreateMenuItemResource([]), $message);
    }
    /**
     * Respond with no content.
     *
    ...
    {
        return $this->respondWithResourceCollection(new MenuItemCollection([]), $message);
    }
